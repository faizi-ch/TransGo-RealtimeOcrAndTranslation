...
public final class ViewfinderView extends View {
  ...
  static final boolean DRAW_TEXTLINE_BOXES = false;//true
  ...
  static boolean DRAW_WORD_BOXES = true;//true
  ...
  static boolean DRAW_WORD_TEXT = true;//true
