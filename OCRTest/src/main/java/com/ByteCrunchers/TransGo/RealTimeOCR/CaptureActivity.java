...
import com.ByteCrunchers.TransGo.RealTimeOCR.camera.CameraManager;
import com.ByteCrunchers.TransGo.RealTimeOCR.camera.ShutterButton;
import com.ByteCrunchers.TransGo.RealTimeOCR.language.LanguageCodeHelper;
import com.ByteCrunchers.TransGo.RealTimeOCR.language.TranslateAsyncTask;
import com.ByteCrunchers.TransGo.RealTimeOCR.language.YandexTranslatorBackgroundTask;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback, 
  ...
  public static final String DEFAULT_TRANSLATOR = "Yandex Translator";
  ...
  private ResideMenuItem itemLight;
  private ResideMenuItem itemDrawBoxes;
  private ResideMenuItem itemDrawWords;
  ...
  boolean handleOcrDecode(OcrResult ocrResult) {
    ...
    if (isTranslationActive) {
      ...
      if (api.equals(PreferencesActivity.TRANSLATOR_YANDEX)) {
        Toast.makeText(this,sourceLanguageCodeTranslation+"-"+targetLanguageCodeTranslation+"="+ocrResult.getText(),Toast.LENGTH_LONG).show();
        new YandexTranslatorBackgroundTask(this, sourceLanguageCodeTranslation, targetLanguageCodeTranslation,
  ...
  void handleOcrContinuousDecode(OcrResult ocrResult) {
    ...
    if (CONTINUOUS_DISPLAY_METADATA) {
      ...
      statusViewBottom.setText("OCR: " + sourceLanguageReadable + " - Mean confidence: " + meanConfidence.toString() + " - Time required: " + recognitionTimeRequired + " ms");
        //new YandexTranslatorBackgroundTask(this, sourceLanguageCodeTranslation, targetLanguageCodeTranslation,
         //       ocrResult.getText()).execute();
    }
  }
  ...
  private void setUpMenu() {
    ...
    resideMenu.setBackground(R.drawable.rsz_wisdom);
    ...
    itemDrawWords = new ResideMenuItem(this, R.drawable.ic_draw_words, "Draw Words: On");
    itemDrawBoxes = new ResideMenuItem(this, R.drawable.ic_draw_boxes, "Draw Boxes: On");
    itemLight=new ResideMenuItem(this, R.drawable.ic_flashlight, "Flash Light: Off");
    ...
    itemHome.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        Intent launchIntent = getPackageManager().getLaunchIntentForPackage("com.ByteCrunchers.TransGo");
    ...
    itemSettings.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        Intent intent;
        intent = new Intent().setClass(mContext, PreferencesActivity.class);
        startActivity(intent);
    ...
    itemDrawWords.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        boolean currentSetting=viewfinderView.DRAW_WORD_TEXT;
if (currentSetting)
{
  viewfinderView.DRAW_WORD_TEXT=false;
  itemDrawWords.setTitle("Draw Words: Off");
}
else
{
  viewfinderView.DRAW_WORD_TEXT=true;
  itemDrawWords.setTitle("Draw Words: On");
}
        resideMenu.closeMenu();
      }
    });
    itemLight.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        ...
        if (currentSetting) {
          ...
          prefs.edit().putBoolean(PreferencesActivity.KEY_TOGGLE_LIGHT, false).apply();
          ...
          startActivity(intent);
          finish();
          intent = new Intent().setClass(mContext, CaptureActivity.class);
          startActivity(intent);
          onBackPressed();

          itemLight.setTitle("Flash Light: Off");
      }
      else
        {
          //SharedPreferences.Editor editor = prefs.edit();
          prefs.edit().putBoolean(PreferencesActivity.KEY_TOGGLE_LIGHT, true).apply();
          itemLight.setTitle("Flash Light: On");
    ...
    itemDrawBoxes.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        boolean currentSetting=viewfinderView.DRAW_WORD_BOXES;
        if (currentSetting)
        {
          viewfinderView.DRAW_WORD_BOXES=false;
          itemDrawBoxes.setTitle("Draw Boxes: Off");
        }
        else
        {
          viewfinderView.DRAW_WORD_BOXES=true;
          itemDrawBoxes.setTitle("Draw Boxes: On");
        }
        resideMenu.closeMenu();
      }
    });
    ...
    resideMenu.addMenuItem(itemDrawWords, ResideMenu.DIRECTION_RIGHT);
    resideMenu.addMenuItem(itemDrawBoxes, ResideMenu.DIRECTION_RIGHT);
    resideMenu.addMenuItem(itemLight, ResideMenu.DIRECTION_RIGHT);
