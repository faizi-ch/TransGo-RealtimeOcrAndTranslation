...
import com.ByteCrunchers.TransGo.RealTimeOCR.PreferencesActivity;
...
public class Translator {
  ...
  static String translate(Activity activity, String sourceLanguageCode, String targetLanguageCode, String sourceText) {   
    ...
    } /*else if (api.equals(PreferencesActivity.TRANSLATOR_YANDEX)) {
TranslatorYandex.SetYandexTranslateContext(activity.getBaseContext());
      // Get the correct code for the source language for this translation service.
      sourceLanguageCode = TranslatorYandex.toLanguage(
              LanguageCodeHelper.getTranslationLanguageName(activity.getBaseContext(), sourceLanguageCode));

      return TranslatorYandex.translate(sourceLanguageCode, targetLanguageCode, sourceText);
    }*/
