...
public class OcrCharacterHelper {
  ...
  public static final String KEY_CHARACTER_BLACKLIST_URDU = "preference_character_blacklist_urdu";
  ...
  public static final String KEY_CHARACTER_WHITELIST_URDU = "preference_character_whitelist_urdu";
  ...
  public static String getDefaultBlacklist(String languageCode) {
    ...
    else if (languageCode.equals("urd")) { return ""; } // Urdu
  ...
  public static String getDefaultWhitelist(String languageCode) {
    ...
    else if (languageCode.equals("urd")) { return ""; } // Ukrainian
    else if (languageCode.equals("vie")) { return ""; } // Vietnamese
    else {
      throw new IllegalArgumentException();
    }
  ...
  public static String getBlacklist(SharedPreferences prefs, String languageCode) {
    ...
    else if (languageCode.equals("urd")) { return prefs.getString(KEY_CHARACTER_BLACKLIST_URDU, getDefaultBlacklist(languageCode)); }
  ...
  public static String getWhitelist(SharedPreferences prefs, String languageCode) {
    ...
    else if (languageCode.equals("urd")) { return prefs.getString(KEY_CHARACTER_WHITELIST_URDU, getDefaultWhitelist(languageCode)); }
  ...
  public static void setBlacklist(SharedPreferences prefs, String languageCode, String blacklist) {
    ...
    else if (languageCode.equals("urd")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_URDU, blacklist).commit(); }
  ...
  public static void setWhitelist(SharedPreferences prefs, String languageCode, String whitelist) {
    ...
    else if (languageCode.equals("urd")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_URDU, whitelist).commit(); }
